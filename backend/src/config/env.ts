...
const envSchema = z.object({
  ...
  ASSISTANT_PROVIDER: z.enum(['mock']).default('mock'),
  ...
  VNPT_VOICE_ACCESS_TOKEN: z.string().default(''),
  VNPT_VOICE_TOKEN_ID: z.string().default(''),
  VNPT_VOICE_TOKEN_KEY: z.string().default(''),
});
