    ...
    <div className="main-content animate-fade-in">
      ...
      <section className="home-hero" aria-label="Giới thiệu">
        <div className="home-hero-content">
          ...
          <p>
            Thực hiện thủ tục hành chính nhanh chóng với sự hỗ trợ của Trợ lý
            AI. Tự động điền form, hướng dẫn từng bước, xác thực thông tin tức
            thì.
          </p>
      ...
      {/* <section className="stats-bar" aria-label="Thống kê">
        {[
          { value: "50+", label: "Dịch vụ trực tuyến", id: "stat-services" },
          { value: "24/7", label: "Hỗ trợ AI", id: "stat-support" },
          { value: "< 3 ngày", label: "Thời gian xử lý", id: "stat-time" },
          { value: "100%", label: "Miễn phí", id: "stat-fee" },
        ].map((stat) => (
          <div className="stat-item" key={stat.id} data-highlight-id={stat.id}>
      ...
      >
        <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><img src="/logo_Gov_Bridge.jpg" alt="Gov Bridge AI" style={{ width: 56, height: 56, borderRadius: '50%', objectFit: 'cover', border: '2px solid #C8441A', padding: 2, background: 'white' }} /></div>
        <div style={{ flex: 1 }}>
          <h2
            style={{
              fontSize: "1.125rem",
          ...
          >
            Nhấn nút <strong><img src="/logo_Gov_Bridge.jpg" alt="AI" style={{ width: 18, height: 18, borderRadius: '50%', objectFit: 'cover', verticalAlign: 'middle', marginRight: 4, display: 'inline-block', border: '1px solid #C8441A' }} /> Trợ lý AI</strong> ở góc phải màn hình để được
            hướng dẫn, tự động điền form bằng giọng nói hoặc ảnh CCCD, và nhiều
