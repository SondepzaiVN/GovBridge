...
const legalOwnerOptions = [
    'Chủ hộ là chủ sở hữu chỗ ở hợp pháp',
    'Cha/mẹ là chủ sở hữu chỗ ở hợp pháp',
    'Người giám hộ là chủ sở hữu chỗ ở hợp pháp',
    'Người thân khác là chủ sở hữu chỗ ở hợp pháp',
];
const confirmerRelationOptions = [
    'Chủ hộ',
...
const getSteps = (opts: Record<string, string[] | undefined>): LinkedStep[] => [
        ...
        sections: [
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_truongHopKhaiSinh',
                        label: 'Trường hợp khai sinh',
                        type: 'select',
                        required: true,
                        wide: true,
                        options: birthCaseOptions,
                    },
                ],
            },
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_truongHopDangKyThuongTru',
                        label: 'Trường hợp ĐKTT',
                        type: 'select',
                        required: true,
                        wide: true,
                        options: residenceCaseOptions,
                    },
                ],
            },
            {
        ...
        sections: [
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_ngaySinhNguoiYeuCau',
                        label: 'Ngày sinh người yêu cầu',
                        type: 'date',
                        required: true,
                        span: 3,
                    },
                    {
                        id: 'ltks_gioiTinhNguoiYeuCau',
                        label: 'Giới tính',
                        type: 'select',
                        required: true,
                        span: 3,
                    ...
                    {
                        id: 'ltks_quocGiaNguoiYeuCau',
                        label: 'Quốc gia',
                        type: 'select',
                        required: true,
                        span: 6,
                        options: countryOptions,
                        value: 'Cộng hòa XHCN Việt Nam',
                    },
                    {
                        id: 'ltks_tinhNguoiYeuCau',
                        label: 'Tỉnh/Thành phố',
                        type: 'select',
                        required: true,
                        span: 6,
                    ...
                    {
                        id: 'ltks_phuongNguoiYeuCau',
                        label: 'Phường/Xã',
                        type: 'select',
                        required: true,
                        span: 6,
                        options: opts.wardsNguoiYeuCau,
                    },
                    { id: 'ltks_chiTietNguoiYeuCau', label: 'Chi tiết', type: 'text', required: true, wide: true },
                    {
                        id: 'ltks_quanHeVoiTre',
                        label: 'Quan hệ với người được khai sinh',
                        type: 'select',
                        required: true,
                        span: 3,
                        options: requesterRelationOptions,
                    },
                    {
                        id: 'ltks_quanHeVoiTreKhac',
                        label: 'Quan hệ với người được khai sinh (khác)',
                        type: 'text',
                        span: 3,
                    },
            ...
            },
            {
                ...
                fields: [
                    {
                        id: 'ltks_nhapThongTinTre',
                        label: 'Phương thức nhập',
                        type: 'radio',
                        required: true,
                        wide: true,
                        hideLabel: true,
                        options: ['Nhập tay', 'Lấy dữ liệu chứng sinh từ CSDL Bảo hiểm'],
                        value: 'Nhập tay',
                    },
                    ...
                    {
                        id: 'ltks_phuongNoiSinh',
                        label: 'Phường/Xã',
                        type: 'select',
                        required: true,
                        span: 4,
                        options: opts.wardsNoiSinh,
                    },
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_phuongQueQuan',
                        label: 'Phường/Xã',
                        type: 'select',
                        span: 4,
                        options: opts.wardsQueQuan,
                    },
                ...
                fields: [
                    {
                        ...
                        label: 'Chủ hộ là cha/mẹ',
                        type: 'checkbox',
                        wide: true,
                        hideLabel: true,
                        options: ['Bố là chủ hộ', 'Mẹ là chủ hộ'],
                    },
                    ...
                    {
                        id: 'ltks_quanHeVoiChuHo',
                        label: 'Mối quan hệ của người được khai sinh với chủ hộ',
                        type: 'select',
                        required: true,
                        span: 4,
                        options: ['Con', 'Cháu', 'Người được giám hộ', 'Khác'],
                    },
                    {
                        id: 'ltks_loaiChuSoHuuChoO',
                        label: 'Loại chủ sở hữu chỗ ở hợp pháp',
                        type: 'select',
                        span: 6,
                        options: legalOwnerOptions,
                    },
                    {
                        id: 'ltks_loaiThanNhanXacNhan',
                        label: 'Loại thân nhân xác nhận',
                        type: 'select',
                        span: 6,
                        options: confirmerRelationOptions,
                    },
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_phuongDangKyThuongTru',
                        label: 'Phường/Xã',
                        type: 'select',
                        required: true,
                        span: 6,
                        options: opts.wardsDangKyThuongTru,
                    },
            ...
            },
            {
                ...
                fields: [
                    ...
                    {
                        id: 'ltks_thongTinGiamHoTrenThe',
                        label: 'Thông tin giám hộ trên thẻ',
                        type: 'select',
                        required: true,
                        span: 6,
    ...
    },
    {
        ...
        sections: [{ title: 'Hoàn thành nộp hồ sơ', complete: true, hideTitle: true }],
    },
];
...
const LienThongKhaiSinhPage: React.FC = () => {
    ...
    const service = SERVICE_MAP['khai-sinh'] || {
        requiredDocs: [],
        steps: [],
        processingTime: '',
        fee: '',
    ...
    const getFieldValue = (field: LinkedField) =>
        getAgencyFieldValue(field.id) ?? formState.values[field.id] ?? field.value ?? '';
        ...
        <LienThongShell>
            <main className="ltks-main">
                ...
                <div className="dktt-required-note">
                    <strong>Ghi chú:</strong> Các thông tin có dấu <span className="red">(*)</span> là thông tin bắt
                    buộc phải nhập
                </div>
                                                    ...
                                                    onChange={(event) => {
                                                        ...
                                                        if (checked) {
                                                            setFieldValue(
                                                                'ltks_tinhThuongTru',
                                                                formState.values.ltks_tinhKhaiSinh ??
                                                                    fieldDefaults.get('ltks_tinhKhaiSinh') ??
                                                                    '',
                                                            );
                                                            setFieldValue(
                                                                'ltks_phuongThuongTru',
                                                                formState.values.ltks_phuongKhaiSinh ??
                                                                    fieldDefaults.get('ltks_phuongKhaiSinh') ??
                                                                    '',
                                                            );
                                                        }
                                                    }}
...
const LienThongShell: React.FC<React.PropsWithChildren> = ({ children }) => (
    <div className="ltks-page ltks-app-page animate-slide-up">{children}</div>
);
...
const FieldControl: React.FC<FieldControlProps> = ({ field, value, error, onChange }) => {
    ...
    return (
        <div
            className={`ltks-field ${field.wide || field.type === 'textarea' ? 'wide' : ''} ${field.span ? `span-${field.span}` : ''} ${field.dotted ? 'dotted' : ''}`}
        >
            {!field.hideLabel && (
    ...
    return (
        <div className="ltks-result-options">
            ...
            <div className="ltks-result-field">
                <label htmlFor="ltks_noiTraKetQua" className="required">
                    Nơi trả kết quả
                </label>
                <input
            ...
            <div className="ltks-captcha-row">
                <div className="ltks-result-field">
                    <label htmlFor="ltks_captcha" className="required">
                        Nhập mã kiếm tra
                    </label>
                    <input
                        id="ltks_captcha"
            ...
            <label className="ltks-material-check pledge-check">
                ...
                />
                <span />
                Tôi cam đoan nội dung đề nghị trên đấy là đúng sự thật, được sự thỏa thuận nhất trí của các bên liên
                quan theo quy định pháp luật. Tôi chịu hoàn toàn trách nhiệm trước pháp luật về nội dung cam đoan của
                mình.
            </label>
            ...
            <div className="ltks-complete-content">
                ...
                <div className="ltks-complete-inner">
                    ...
                    <div className="ltks-complete-copy">
                        <p>
                            Thời gian giải quyết của <strong>hồ sơ liên thông</strong> là không quá{' '}
                            <strong>03 ngày làm việc</strong> kể từ khi cán bộ tiếp nhận hồ sơ.
                        </p>
                        <p>Cụ thể:</p>
                        <ul>
                            ...
                            <li>
                                Hồ sơ cấp thẻ bảo hiểm y tế cho trẻ dưới 6 tuổi: được chuyển xử lý theo dữ liệu liên
                                thông đã kê khai.
                            </li>
                        </ul>
                    </div>
...
const ReviewPanel: React.FC<{ values: Record<string, string> }> = ({ values }) => {
    const babyName =
        [values.ltks_hoTre, values.ltks_chuDemTre, values.ltks_tenTre].filter(Boolean).join(' ') || 'Chưa nhập';
    ...
    return (
        <div className="ltks-review">
            <div>
                ...
                <span>Liên thông đăng ký khai sinh, đăng ký thường trú, cấp thẻ BHYT cho trẻ dưới 6 tuổi</span>
            </div>
            <div>
            ...
            <div>
                ...
                <span>Hồ sơ sẽ được sinh sau khi gửi</span>
            </div>
            <p>
                Vui lòng ghi nhớ các thông tin bên dưới để theo dõi tình hình xử lý hoặc cập nhật thông tin hồ sơ của
                bạn.
            </p>
        </div>
    );
